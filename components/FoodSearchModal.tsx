...
const COMMON_FOODS = [
  "Oatmeal & Berries", "Greek Yogurt", "Grilled Chicken Salad", "Avocado Toast",
  "Protein Shake", "Salmon & Asparagus", "Brown Rice Bowl", "Sweet Potato",
  "Almonds", "Apple slices", "Hard Boiled Eggs"
];

const FoodSearchModal: React.FC<FoodSearchModalProps> = ({ isOpen, onClose, onAdd }) => {
  ...
  const filtered = COMMON_FOODS.filter(s => s.toLowerCase().includes(searchTerm.toLowerCase()));
