...
const SupplementModal: React.FC<SupplementModalProps> = ({
  ...
  const filtered = COMMON_SUPPLEMENTS.filter((s) =>
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`relative w-full max-w-md bg-[#1f2e18] rounded-t-[2rem] p-6 shadow-2xl transform transition-transform duration-300 ease-out flex flex-col gap-6 max-h-[80vh] ${
