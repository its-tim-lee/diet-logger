...
Build-time CSS bundling with Tailwind v3, PostCSS, and Autoprefixer, generating optimized CSS purged of unused styles. Eliminates runtime CDN dependencies for offline support and reduced bundle size.
...
- **WHEN** the Tailwind configuration is loaded
- **THEN** content paths include "./src/**/*.{js,ts,jsx,tsx}"

#### Scenario: Configuration includes component files

- **WHEN** the Tailwind configuration is loaded
- **THEN** content paths include "./components/**/*.{js,ts,jsx,tsx}"
